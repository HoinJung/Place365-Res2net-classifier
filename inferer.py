...
#         self.model_path = self.config['result_path'] + '/epoch_018_ckpt.pth'
        self.model_path = self.config['result_path'] + '/epoch_028_ckpt.pth'
...
#                     save_file_list.append([image, gt_, name_,pred_,pred_name])
...
#         result_df=pd.concat([data_df,topk_df], axis =1)
        ...
        result_df.to_csv('./result_series2.csv')
